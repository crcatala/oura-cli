...
Thanks for your interest in oura-cli.
...
existing issues before opening a new one. Never include credentials, tokens,
session IDs, or real API responses from an Oura account.

## Security issues

Please do not report security vulnerabilities in a public issue. Contact
[@crcatala](https://github.com/crcatala) privately instead, or use the private
